...
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY H4SSA1N🤍*",
// set the auto reply massage on status reply  
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "🦋𝗜𝗧𝗔𝗖𝗛𝗜 ✞︎ 𝗨𝗖𝗛𝗜𝗛𝗔 ♂️",
...
OWNER_NAME: process.env.OWNER_NAME || "𝗠𝗥_𝗛𝗨𝗦𝗦𝗔𝗜𝗡",
// add bot owner name
